...
The system has been tested on Windows 7, 8, 10, and 11. It now targets .NET 10 for Windows, so you will need the .NET 10 Desktop Runtime installed on the PC where you run it. Note for Geeks: the application was developed using Visual Studio 2022 and uses Windows Forms. Task Factory is used to provide asynchronous screen updating.
